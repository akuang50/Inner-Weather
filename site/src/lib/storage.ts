...
/** Bootstrap history so baselines exist; your new entries are real and override the story. */
export function seedTracker(): TrackerState {
  ...
  const texts = [
    ...
    { ago: 4, text: "I keep telling myself I'll work on the project tonight but I just end up scrolling. There's so much to do." },
    { ago: 2, text: "I don't even know where to start. Everything is piling up and the deadline is Friday." },
    { ago: 1, text: 'Project deadline keeps looping in my head. Slept badly. I have so much to do and I am behind.' },
  ]
